            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() == 1) {
                    ...
                    if (filaSeleccionada >= 0) {
                        ...
                        String horaCerro = (modelo.getValueAt(filaSeleccionada, 2) != null)?(modelo.getValueAt(filaSeleccionada, 2).toString()): "=";
                        String nombre = (modelo.getValueAt(filaSeleccionada, 3) != null)?(modelo.getValueAt(filaSeleccionada, 3).toString()): "=";
                        String telefono = (modelo.getValueAt(filaSeleccionada, 4) != null)?(modelo.getValueAt(filaSeleccionada, 4).toString()): "=";
                        String ciudad = (modelo.getValueAt(filaSeleccionada, 5) != null)?(modelo.getValueAt(filaSeleccionada, 5).toString()): "=";
                        String direccion = (modelo.getValueAt(filaSeleccionada, 6) != null)?(modelo.getValueAt(filaSeleccionada, 6).toString()): "=";
                        String departamento = (modelo.getValueAt(filaSeleccionada, 7) != null)?(modelo.getValueAt(filaSeleccionada, 7).toString()): "=";
                        String valorDeclarado = (modelo.getValueAt(filaSeleccionada, 9) != null)?(modelo.getValueAt(filaSeleccionada, 9).toString()): "=";
                        String borrada = (modelo.getValueAt(filaSeleccionada, 10) != null)?(modelo.getValueAt(filaSeleccionada, 10).toString()): "=";
                        String anulada = (modelo.getValueAt(filaSeleccionada, 11) != null)?(modelo.getValueAt(filaSeleccionada, 11).toString()): "=";
